...
pub struct Ui {
    ...
    pub(crate) account_email: gtk::Label,
    ...
    pub(crate) account_connect: adw::ActionRow,
    pub(crate) account_disconnect: adw::ActionRow,
...
pub(crate) struct WeakUi {
    ...
    account_email: gtk::glib::WeakRef<gtk::Label>,
    ...
    account_connect: gtk::glib::WeakRef<adw::ActionRow>,
    account_disconnect: gtk::glib::WeakRef<adw::ActionRow>,
...
impl Ui {
    pub(crate) fn downgrade(&self) -> WeakUi {
        WeakUi {
            ...
            account_email: self.account_email.downgrade(),
            ...
            account_connect: self.account_connect.downgrade(),
            account_disconnect: self.account_disconnect.downgrade(),
...
impl WeakUi {
    pub(crate) fn upgrade(&self) -> Option<Ui> {
        Some(Ui {
            ...
            account_email: self.account_email.upgrade()?,
            ...
            account_connect: self.account_connect.upgrade()?,
            account_disconnect: self.account_disconnect.upgrade()?,
